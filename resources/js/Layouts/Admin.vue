    ...
    <div>
        <div class="min-h-screen bg-gray-100">
            ...
            <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 my-10">
                <div class="mt-4">
                    <div class="border-b border-gray-300 pb-2 space-x-4">
                        <NavLink class="pb-1 " :href="route('admin.home.index')" :active="route().current('admin.home.index')">Home</NavLink>
                        <NavLink class="pb-1 " :href="route('admin.products.index')" :active="route().current('admin.products.index')">Products</NavLink>
                        <NavLink :href="route('admin.orders.index')" :active="route().current('admin.orders.index')">Orders</NavLink>
                    </div>
                    <div class="text-center py-4 text-lg mt-4">
                       <slot name="title" />
                    </div>
                    <slot />
                </div>
            ...
            <footer class="bg-blue-600 text-white">
                <div class="grid sm:grid-cols-2 md:grid-cols-4 gap-4 justify-center max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8">
                    <h1 class="text-lg font-bold text-center sm:text-left border-b border-white sm:border-0 sm:col-span-2 md:col-span-1">Online Store</h1>
                    <div class="">
