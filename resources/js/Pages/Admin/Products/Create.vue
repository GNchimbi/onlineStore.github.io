...
<template>
    <AdminLayout>
        ...
        <div class="rounded-md overflow-hidden border border-gray-400 max-w-2xl mx-auto">
            <h1 class="border-b border-gray-400 bg-transparent py-4 px-4">Create Product</h1>
            <form class="px-2 py-2 bg-white space-y-4" @submit.prevent="form.post(route('admin.products.store'))">
                ...
                <div class="grid sm:grid-cols-[100px_minmax(250px,_1fr)] sm:gap-6">
                    ...
                    <input type="file" class="rounded-md" @input="form.image = $event.target.files[0]" ref="photo">
